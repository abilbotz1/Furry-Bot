...
`.trim(), 'Kebijakan ©2022 By Riell San', '⋮☰ Menu', '.menu', 'Owner', '.nowner', 'Donasi', '.donasi', m, {
    quoted: m,
    contextInfo: {
        externalAdReply: {
            ...
            mediaType: 2,
          thumbnail: await (await fetch('https://telegra.ph/file/cf555125dd767bcabaf36.jpg')).buffer(),
