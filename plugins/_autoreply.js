let fs = require('fs') 
 ...
        await this.setBio(`☘️ Ultah Riel San : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik
⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | 💌 made Riel San`).catch(_ => _)  
