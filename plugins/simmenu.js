...
const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 ...
                 'jpegThumbnail': await (await fetch('https://telegra.ph/file/cf555125dd767bcabaf36.jpg')).buffer()
                        }
	                  } 
                     }
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: KHURUSHI MULTI-DEVICE*
⚘ *Creator: Stah Riell San*
⚘ *Contact Owner Bot*
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ KHURUSHI IQ-MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ KHURUSHI IQ-MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ KHURUSHI IQ-MD",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di KHURUSHI IQ-MD",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
